...
//
// Di-forwardRef ke <Stage> Konva-nya supaya pemanggil (PreviewClient) bisa
// export kanvas ini langsung jadi JPEG lewat stage.toDataURL() di BROWSER --
// ini penting karena rendering client-side pakai font asli browser, jadi
// TIDAK terkena bug "kotak tofu" yang ada di generate server-side (lihat
// catatan di src/lib/render/renderInvitationImage.ts).
const InvitationCanvasStage = forwardRef<Konva.Stage, InvitationCanvasStageProps>(
  function InvitationCanvasStage(
    { template, formData, fotoAnakDataUrl, logoDataUrl, containerWidth },
    ref
  ) {
...
export default InvitationCanvasStage;
